...
Replace this section with the supported versions for `clifingerprint`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `clifingerprint` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in clifingerprint.
