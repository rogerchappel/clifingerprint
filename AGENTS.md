# Agent Operating Instructions for clifingerprint

This file defines how AI agents and human maintainers should work in `clifingerprint`.

## Project Context

- Project: `clifingerprint`
- Repository: ``
- Primary maintainer: ``
- Default branch: ``
- Package manager: ``
